...
- Probate autopilot source-run foundation is implemented and extended with durable local source-run state, source-row artifact writing, safe source-file adapter/CLI, read-only Harris+Montgomery export adapter contract, repeatable source-packet CLI inputs, duplicate-case aggregate anomalies, SLA/anomaly brief sections, read-only doctor CLI with freshness SLA, Mission Control health API/client, page-level Mission Control Autopilot health panel, and operator next-action brief sections. QC: `docs/qc/2026-05-15/probate-autopilot-source-foundation/`, `docs/qc/2026-05-15/probate-autopilot-durable-source-rows/`, `docs/qc/2026-05-15/probate-source-file-adapter-operator-health/`, `docs/qc/2026-05-15/probate-autopilot-doctor/`, `docs/qc/2026-05-15/probate-source-adapters-health-surface/`, `docs/qc/2026-05-15/probate-autopilot-mission-control-health-panel/`.
...
2. Next no-send probate gate: wire real Harris/Montgomery source-provider adapters only behind explicit live-source approval gates; keep the Mission Control Autopilot page read-only and sourced from `/mission-control/probate-autopilot/health`.
