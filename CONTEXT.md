...
- Probate autopilot source-run foundation is implemented and extended with durable local source-run state, source-row artifact writing, and operator next-action brief sections. QC: `docs/qc/2026-05-15/probate-autopilot-source-foundation/`, `docs/qc/2026-05-15/probate-autopilot-durable-source-rows/`.
