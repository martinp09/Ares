...
- Rich probate/heir/contact/mailing/property/tax-overlay fields have been added to HubSpot and read back on the first real lead correction; for `lead_341`, applicant/heir data is present but property address/HCAD remain blank because no property match exists in current Ares data.
