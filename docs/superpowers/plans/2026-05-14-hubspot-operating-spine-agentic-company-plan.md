...
- Rich probate/heir/contact/mailing/property/tax-overlay fields have been added to HubSpot and read back on the first real lead correction; for `lead_341`, applicant/heir data and standard contact address fields are present, but email/phone and property address/HCAD remain blank because no contact enrichment/property match exists in current Ares data.
