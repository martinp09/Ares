...
1. Capture stronger primary Sultanic source material via authenticated browser, alternate transcript source, or manual source upload.
2. Add Mission Control read/approval endpoints for offers and copy assets.
3. Persist offer/copy assets in a repository instead of service-generated constants.
4. Connect performance events back into wiki/copy asset reports after actual approved campaigns run.
