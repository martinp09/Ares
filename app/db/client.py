...
class InMemoryControlPlaneStore:
    ...
    release_events: dict[str, object] = field(default_factory=dict)
    release_event_ids_by_agent: dict[str, list[str]] = field(default_factory=dict)
    ...
    catalog_entries: dict[str, object] = field(default_factory=dict)
    catalog_entry_keys: dict[tuple[str, str], str] = field(default_factory=dict)
    catalog_entry_ids_by_org: dict[str, list[str]] = field(default_factory=dict)
    agent_installs: dict[str, object] = field(default_factory=dict)
    agent_install_ids_by_org: dict[str, list[str]] = field(default_factory=dict)
    ...
    provider_object_links: dict[str, object] = field(default_factory=dict)
    provider_object_link_provider_keys: dict[tuple[str, str, str, str, str], str] = field(default_factory=dict)
    provider_object_link_ares_keys: dict[tuple[str, str, str, str, str, str], str] = field(default_factory=dict)
    provider_sync_cursors: dict[str, object] = field(default_factory=dict)
    provider_sync_cursor_keys: dict[tuple[str, str, str, str], str] = field(default_factory=dict)
    provider_sync_runs: dict[str, object] = field(default_factory=dict)
    provider_sync_run_keys: dict[tuple[str, str, str, str, str], str] = field(default_factory=dict)
    ...
    sms_agent_jobs: dict[str, object] = field(default_factory=dict)
    sms_agent_job_keys: dict[tuple[str, str, str | None, str | None, str | None], str] = field(default_factory=dict)
    sms_agent_decisions: dict[str, object] = field(default_factory=dict)
    sms_agent_eval_labels: dict[str, object] = field(default_factory=dict)
    sms_agent_eval_label_keys: dict[tuple[str, str], str] = field(default_factory=dict)
    crm_records: dict[str, object] = field(default_factory=dict)
    crm_record_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    crm_source_records: dict[str, object] = field(default_factory=dict)
    crm_source_record_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    crm_record_source_memberships: dict[str, object] = field(default_factory=dict)
    crm_record_source_membership_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    ...
    crm_record_saved_views: dict[str, object] = field(default_factory=dict)
    crm_record_saved_view_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    ...
    deal_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    deal_parties: dict[str, object] = field(default_factory=dict)
    deal_party_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    deal_tasks: dict[str, object] = field(default_factory=dict)
    deal_task_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    deal_document_requirements: dict[str, object] = field(default_factory=dict)
    deal_document_requirement_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
    deal_audit_events: dict[str, object] = field(default_factory=dict)
    deal_audit_event_keys: dict[tuple[str, str, str], str] = field(default_factory=dict)
...
def reset_control_plane_store(store: InMemoryControlPlaneStore | None = None) -> None:
    ...
    target.release_events.clear()
    target.release_event_ids_by_agent.clear()
    ...
    target.catalog_entries.clear()
    target.catalog_entry_keys.clear()
    target.catalog_entry_ids_by_org.clear()
    target.agent_installs.clear()
    target.agent_install_ids_by_org.clear()
    ...
    target.provider_object_links.clear()
    target.provider_object_link_provider_keys.clear()
    target.provider_object_link_ares_keys.clear()
    target.provider_sync_cursors.clear()
    target.provider_sync_cursor_keys.clear()
    target.provider_sync_runs.clear()
    target.provider_sync_run_keys.clear()
    target.tasks.clear()
    target.task_keys.clear()
    target.title_packets.clear()
    target.title_packet_keys.clear()
    target.sms_agent_jobs.clear()
    target.sms_agent_job_keys.clear()
    target.sms_agent_decisions.clear()
    target.sms_agent_eval_labels.clear()
    target.sms_agent_eval_label_keys.clear()
    target.crm_records.clear()
    target.crm_record_keys.clear()
    target.crm_source_records.clear()
    target.crm_source_record_keys.clear()
    target.crm_record_source_memberships.clear()
    target.crm_record_source_membership_keys.clear()
    target.crm_record_status_history.clear()
    target.crm_record_promotions.clear()
    target.crm_record_promotion_keys.clear()
    target.crm_record_saved_views.clear()
    target.crm_record_saved_view_keys.clear()
    ...
    target.deals.clear()
    target.deal_keys.clear()
    target.deal_parties.clear()
    target.deal_party_keys.clear()
    target.deal_tasks.clear()
    target.deal_task_keys.clear()
    target.deal_document_requirements.clear()
    target.deal_document_requirement_keys.clear()
    target.deal_audit_events.clear()
    target.deal_audit_event_keys.clear()
