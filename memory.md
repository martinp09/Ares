...
- `/opt/ares/worktrees/ares-main` currently has `fix/probate-autopilot-enrichment-wiring` active for the Harris+Montgomery probate autopilot operational no-send execution.
